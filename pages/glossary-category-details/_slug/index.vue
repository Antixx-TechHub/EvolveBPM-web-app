        ...
        <div class="row">
          <div class="col-xxl-12">
            <div class="breadcrumb__content breadcrumb__content-2 text-center p-relative z-index-1">
              <h3 class="breadcrumb__title">Glossaries Categories</h3>
              <div class="breadcrumb__list">
                <span><a href="index.html">Home</a></span>
                <span class="dvdr"></span>
                <span>Glossaries Categories</span>
              </div>
            </div>
          </div>
        </div>
...
import CategoryDetails from '../../../components/Glossary/Glossary-CategoriesDetails'
