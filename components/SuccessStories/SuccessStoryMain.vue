                ...
                <div class="col-lg-4 col-md-6" v-for="blog in blogs.slice(
                    ...
                    <div class="single-blog-post">
                        <div class="post-image">
                            <NuxtLink :to="'/success-stories-details/' + blog.attributes.slug" class="d-block">
                        ...
                        <div class="post-content">
                            ...
                            <h3>
                                <NuxtLink :to="'/success-stories-details/' + blog.attributes.slug">
                            ...
                            <NuxtLink :to="'/success-stories-details/' + blog.attributes.slug" class="read-more-btn">
                                Read More
