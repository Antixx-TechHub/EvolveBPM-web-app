            ...
            <div class="row justify-content-center">
                  ...
                  <div class="tpbanner-content-two">
                     <div class="tpbanner-title-two mb-20"><span>Search Engine
                           <svg width="406" height="40" viewBox="0 0 406 40" fill="none"
                              ...
                              <path d="M3.14977 24.4029C3.14977 24.4029 256.329 -7.75032 398.26 15.5002" stroke="#FFCE5A"
                                 stroke-width="5" stroke-linecap="round" />
                              <path d="M3.59029 19.0626C3.59029 19.0626 261.471 -1.12129 402.878 28.422" stroke="#FFCE5A"
                                 stroke-width="5" stroke-linecap="round" />
                           </svg>
               ...
               <div class="col-lg-5 col-md-5 order-1 order-md-2">
                  <div class="tpbanner-two-shape p-relative" data-parallax='{"x": 15, "smoothness": 10}'>
                     <img src="../../assets/img/banner/banner-2-thumb-1.png" alt="image">
