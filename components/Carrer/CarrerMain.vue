            ...
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12">
                    <div class="blog-grid-wrapper">
                        <div class="row">
                            <div class="col-lg-4 col-md-4" v-for="joblisting in joblistings.slice(
                                ...
                                <div class="tpblog-item-2 mb-30">           
                                    <div class="tpblog-wrap">
                                        <div class="tpblog-content-2">
                                            <span>{{ joblisting.attributes.tag }}</span>
                                            <h4 class="tpblog-title-2"><router-link
                                                    :to="'/case-studies-details/' + joblisting.attributes.slug">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="career-btn text-end">
                            <router-link to="/career-details" class="default-btn" style="padding-left: 25px">Apply
                                Now</router-link>
                        </div>
                    </div>
                </div>
