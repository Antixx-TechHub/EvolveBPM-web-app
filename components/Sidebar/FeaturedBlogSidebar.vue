                                ...
                                <div class="sidebar__post rc__post">
                                    <div class="rc__post mb-10 d-flex align-items-center" v-for="blog in blogs.slice(0, 3)"
                                        ...
                                        <div class="rc__post-thumb mr-20">
                                            <router-link :to="'/featured-blog-details/' + blog.attributes.slug" class="thumb">
                                                <img :src="blog.attributes.image.data.attributes.url" alt="blog">
                                            </router-link>
                                        </div>
                                        <div class="rc__post-content">
                                            <h3 class="rc__post-title">
                                                <router-link :to="'/featured-blog-details/' + blog.attributes.slug">
                            ...
                            <div class="sidebar__widget-content">
                                <ul>
                                    <li v-for="blogcategory in blogcategories" :key="blogcategory.id">
                                        <router-link :to="`/featured-category-details/${blogcategory.attributes.slug}`">
